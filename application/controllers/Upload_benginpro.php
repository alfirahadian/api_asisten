<?php 
class Upload_benginpro extends CI_Controller{
	public function __construct()
	{
		parent::__construct();
		$this->load->model('upload_model_benginpro');
	}

	public function index(){
        $this->load->view('view_upload_benginpro');
	}
	...
	public function do_upload(){
		...
		else
		{
			...
			if ( ! $this->upload->do_upload()){
				...
				//var_dump($data);
				//die;
				$this->upload_model_benginpro->add_file($data);
				echo "Berhasil";
				//redirect('beranda');
			}

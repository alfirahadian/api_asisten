              ...
              <div class="card">
                  <div class="card-content light-green lighten-5">
                        ...
                        <tr>
                          ...
                          <td>Register Alumni CNC</td>
                        </tr>
                        </table>
                        </span>
                        </div>
                        <?php echo validation_errors('<p class="error">'); ?>
                          <?php echo form_open_multipart("upload_alumni/do_upload"); ?>
                        <div class="card-content black-text">
                              ...
                              <div class="row">
                                  <div class="input-field col s12 l12">
                                    <label for="divisi">Divisi pertama masuk:</label>
                                    <input type="text" id="divisi" name="divisi" placeholder="Senior Member Network" value="<?php echo set_value('divisi'); ?>" />
                              </div>
                              <div class="row">
                                  <div class="input-field col s12 l12">
                                    <label for="tahun">Tahun masuk lab:</label>
                                    <input type="text" id="tahun" name="tahun" placeholder="2012" value="<?php echo set_value('tahun'); ?>" />
                              </div>
                              <div class="row">
                                  <div class="input-field col s12 l12">
